...
private:
    ...
    vector<vector<vector<double>>>paraScore;
    SearchEngine* help;
    vector<Node*>sorter;
    SearchEngine* helpme;
    vector <double> BookScore;
...
public:
    ...
    int Numberp;
    // int sumpara;
    vector <string> CreateContainer(string question, vector<long long int>& hi, vector<string>& k);
    ...
    Node* get_top_k_para_new(string question, int k, vector<int> final);
    ...
    vector <int> HaveQP(vector <string> hi);
